...
2. Install Docker and start Invisible Key.
3. Open the local admin dashboard once.
4. Configure ngrok, calendar, email, WiFi, and door images.
5. Use the ngrok URL as the normal admin and guest URL.
